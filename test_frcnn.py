...
parser.add_option("--write_path", dest="write_path", help="to write out the image with detections or not.", default='results')
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
	...
	if options.write:
        	...
        	if not os.path.isdir(write_path):
            	 os.mkdir(write_path)
        	cv2.imwrite('./{}/{}'.format(write_path,img_name),img)
